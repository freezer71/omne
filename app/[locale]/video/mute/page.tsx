  ...
  return (
    <>
      <ToolShell locale={locale} category="video" name={tool.name} description={tool.description}
        ...
        <VideoMuteTool {...tool.ui} largeFileWarning={dict.common.largeFileWarning} result={dict.common.result} cancelLabel={dict.common.cancelRun} cancelledLabel={dict.common.runCancelled} mediaError={dict.common.mediaError} />
      </ToolShell>
